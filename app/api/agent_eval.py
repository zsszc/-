...
LIVE_REPORT = ROOT / "data/evals/logistics_agent_eval_report_live.json"
EXPECTED_COUNTS = {
    "policy_process": 100,
    "cross_document": 70,
    "tool_operation": 60,
...
def _live_overview() -> dict:
    ...
    try:
        ...
        return {"status": "ok", "summary": {k: summary.get(k) for k in ("total", "passed", "pass_rate")},
...
def build_overview() -> dict:
    return {"dataset": _dataset_overview(), "live": _live_overview(),
            "commands": {"offline": ".venv-m4-arm/bin/python scripts/eval_logistics_agent.py --offline",
                         "sample": ".venv-m4-arm/bin/python scripts/eval_logistics_agent.py --live --limit 5"}}
