...
async def overview() -> dict:
    ...
    tools = [name for name in ("query_shipment", "estimate_shipping_fee", "classify_logistics_exception", "check_prohibited_item") if any(s.name == name for s in builtin_specs())]
